...
namespace DoAn4.Controllers
{
    ...
    public class CommentController : ControllerBase
    {
        ...
        public async Task<IActionResult> CreateComment([FromRoute] Guid postId, [FromBody] string content)
        {
        ...
        public async Task<IActionResult> UpdateComment([FromRoute] Guid commentId, [FromBody] string content)
        {
            var token = Request.Headers["Authorization"].ToString().Replace("Bearer ", "");
